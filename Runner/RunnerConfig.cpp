...
namespace ster {
    ...
    void RunnerConfig::load_llvm_opt_information(const string &_opt_path, const string &_filename,
        ...
        _alloca_string_at_index(8, "--unreachableblockelim");
        _alloca_string_at_index(9, "--loop-deletion");
        _alloca_string_at_index(10, "--deadargelim");
        _alloca_string_at_index(11, "--globaldce");
        _alloca_string_at_index(12, "-o");
        _alloca_string_at_index(13, _output_filename);
        (_param_ptr.get())[14] = nullptr;
        LOG_IF(FATAL, (_param_ptr.get())[_param_size] != nullptr);
    }
}